        ...
        const LinkedinButton = BUI.Component.create<BUI.Button>(() => {
            return BUI.html`
                <bim-button 
                    ...
                    style='display:flex; flex-direction:row; font-family:"Nunito"; letter-spacing:0.1rem; max-width:fit-content; background-color:transparent !important; padding:0.5rem; align-items:center'
                    tooltip-text='https://www.linkedin.com/in/ygor-fasanella'
                    @click=${() => {window.open('https://www.linkedin.com/in/ygor-fasanella', '_blank')}}
                ><b style='font-size: 1.15rem; color:rgb(239, 239, 239); font-family:"Nunito"; z-index:10; letter-spacing:0.1rem; margin-left:0.2rem'>LinkedIn</b></bim-button>
            `
        })
        const mailButton = BUI.Component.create<BUI.Button>(() => {
            return BUI.html`
                <bim-button 
                    ...
                    style='display:flex; flex-direction:row; font-family:"Nunito"; letter-spacing:0.1rem; max-width:fit-content; background-color:transparent !important; padding:0.5rem; align-items:center'
                    tooltip-text='ygor.fasanella@phd.unipd.it'
                    @click=${() => {window.open('mailto:ygor.fasanella@phd.unipd.it', '_blank')}}
                ><b style='font-size: 1.15rem; color:rgb(239, 239, 239); font-family:"Nunito"; z-index:10; letter-spacing:0.1rem; margin-left:0.2rem'>Mail</b></bim-button>
            `
        })
