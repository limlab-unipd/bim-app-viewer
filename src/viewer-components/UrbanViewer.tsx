                    ...
                    <div style='display:flex; flex-direction:row; gap:0.5rem; align-items:center'>
                        ...
                        <bim-button label='0' tooltip='Load UVL-0' style="flex:1" @click=${async ({target}:{target:BUI.Button})=>{
                            ...
                            try {
                                ...
                                addOverlay(BUI.html`WARNING: an error occurred during the generation of UVL-0 geometries. Please, try again.`,'warning')
                                target.loading = false
                            }
                        }}></bim-button>
                        <bim-label>></bim-label>
                        ...
                        <bim-button label='1' tootltip='Load UVL-1 and hide UVL-0' style="flex:1" @click=${async ({target}:{target:BUI.Button})=>{
                            ...
                            try {
                                ...
                                addOverlay(BUI.html`WARNING: an error occurred during the generation of UVL-1 geometries. Please, try again.`,'warning')
                                target.loading = false
                            }
                        }}></bim-button>
                        <bim-label>></bim-label>
                        ...
                        <div style='display:flex; flex-direction: column; gap:0.5rem; flex:1'>
                            <bim-button label='2.0' tootltip='Load UVL-2.0' @click=${async ({target}:{target:BUI.Button})=>{
                                ...
                                try {
                                    ...
                                    addOverlay(BUI.html`WARNING: an error occurred during the generation of UVL-2.0 geometries. Please, try again.`,'warning')
                                    target.loading = false
                                }
                            }}></bim-button>
                                    ...
                                    <div style='display:flex; gap:0.5rem; padding:0.5rem'>
                                        ...
                                        <bim-button style='flex:0;' label="Param1" @click=${async ({target}:{target:BUI.Button})=>{
                                            ...
                                            try {
                                                ...
                                                addOverlay(BUI.html`WARNING: an error occurred during the generation of UVL-2.1 geometries. Please, try again.`,'warning')
                                                target.loading = false
                                            }
                                        }}></bim-button>
